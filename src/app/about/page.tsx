    ...
    <>
      <div className="flex flex-col-reverse md:flex-row gap-4 h-full justify-center md:justify-start">
        <div className="flex flex-col w-full md:w-1/2">
          ...
          <p className="text-md md:text-xl font-medium mb-8">
        ...
        <div className="flex w-1/2 justify-center items-center self-center">
          <Image src="/about-image.png" alt="Pedro's profile picture" style={{ maxWidth: "100%", height: "auto" }} width={470} height={529} />
        </div>
      </div>
    </>
  );
