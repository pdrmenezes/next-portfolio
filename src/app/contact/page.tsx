  ...
  return (
    <div className="flex h-full flex-col justify-start gap-2">
      ...
      <div className="grid grid-cols-1 grid-rows-4 gap-4 md:grid-cols-3 md:grid-rows-2 md:gap-y-10">
        <Email />
        <a href="https://www.github.com/pdrmenezes" target="_blank" rel="noopener noreferrer" className="group relative w-fit rounded-md p-4">
        ...
        <div className="p-4 md:col-start-1 md:row-start-2 md:p-4">
